...
if (process.env.NODE_ENV !== 'production' && process.env.WELCOME_MESSAGE !== 'false') {
  ...
  // Feedback
  console.log('\x1b[41m\x1b[37m%s\x1b[0m 🦄', ` More NFT solutions! `);
  console.log('\x1b[31m%s\x1b[0m', ` I suggest you get acquainted with my other NFT solutions 🐈`);
  console.log('\x1b[31m%s\x1b[0m', ` For example you can create an NFT catalog!`);
  console.log('\x1b[31m%s\x1b[0m', ` 👉 https://1.envato.market/nft 🚀🚀🚀`);
  console.log();
